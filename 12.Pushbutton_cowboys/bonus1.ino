...
/*Для проверка ни жульнчество был добавлен массив со состояниями кнопок до сигнала.
Нажатие не будет засчитано, если оно произошло до сигнала "пли!", чтобы исправить это нужно отпрустить кнопку и слудующее нажатие будет засчитано.
*/
// https://drive.google.com/file/d/1rZG8yYui8UWXZmxsObOK7SODCnb-DCvH/view?usp=drive_link